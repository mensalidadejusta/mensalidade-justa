              ...
              {escola.dependencia_administrativa === "Privada" && (
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold py-2 px-3 rounded-lg bg-purple-50 text-purple-700 dark:bg-purple-900/20 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-all active:scale-95 cursor-pointer"
                  >
                    {'✏\uFE0F'} Contribuir
                  </button>
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold py-2 px-3 rounded-lg bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-900/30 transition-all active:scale-95 cursor-pointer"
                  >
