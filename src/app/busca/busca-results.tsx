        ...
        return (
          <article key={escola.id}>
            <Link
              ...
              className={`block bg-neutral-900 border rounded-2xl p-4 transition-all duration-300 ease-in-out ${
                isHovered
                  ? "border-blue-500/40 -translate-y-1 shadow-[0_0_20px_-5px_rgba(59,130,246,0.3),0_-4px_20px_-8px_rgba(139,92,246,0.2),0_4px_20px_-8px_rgba(236,72,153,0.15)]"
                  : "border-neutral-800 hover:border-neutral-700 hover:-translate-y-1 hover:shadow-[0_0_20px_-5px_rgba(59,130,246,0.2),0_-4px_20px_-8px_rgba(139,92,246,0.15),0_4px_20px_-8px_rgba(236,72,153,0.1)]"
              }`}
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <h2 className="text-sm font-semibold text-neutral-100 tracking-tight leading-snug">
                    {escola.nome}
                  </h2>
              ...
              <div className="mt-3 pt-3 border-t border-neutral-800/60 space-y-1.5">
                <div className="flex items-center justify-between gap-2">
                  ...
                  {escola.distancia_km !== undefined && (
                    <p className="shrink-0 text-xs font-semibold text-neutral-400 bg-neutral-800 px-2 py-0.5 rounded-md">
                ...
                {escola.dependencia_administrativa === "Privada" && (
                  <div className="flex gap-2 pt-2">
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold py-2 px-3 rounded-lg bg-purple-500/10 text-purple-300 hover:bg-purple-500/20 transition-all duration-200 active:scale-95 cursor-pointer"
                    >
                      {'✏\uFE0F'} Contribuir
                    </button>
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold py-2 px-3 rounded-lg bg-green-500/10 text-green-300 hover:bg-green-500/20 transition-all duration-200 active:scale-95 cursor-pointer"
                    >
