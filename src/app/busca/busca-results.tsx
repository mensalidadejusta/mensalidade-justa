                ...
                {escola.dependencia_administrativa === "Privada" && (
                  <div className="flex gap-1.5 md:gap-2 pt-1.5 md:pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1 md:gap-1.5 text-[10px] md:text-xs font-semibold py-1.5 md:py-2 px-2 md:px-3 rounded-lg bg-success/10 text-emerald-300 hover:bg-success/20 transition-all duration-300 active:scale-95 cursor-pointer"
                    >
