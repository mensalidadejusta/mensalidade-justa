  ...
  return (
    <div className="min-h-dvh bg-bg text-text selection:bg-primary/30">
      ...
      <div className="fixed inset-0 bottom-0 z-[500] pointer-events-none">
        ...
        {/* Botao WhatsApp canto inferior esquerdo */}
        <a
          href={"https://wa.me/?text=" + encodeURIComponent(
            "Conhe\u00e7a o Mensalidade Justa! \u00c9 uma plataforma gratuita onde voc\u00ea pode consultar e compartilhar valores reais de mensalidades escolares. Ajude outros pais e respons\u00e1veis a tomar decis\u00f5es mais justas. Acesse: https://mensalidadejusta.com.br"
          )}
          target="_blank" rel="noopener noreferrer"
          className="absolute bottom-20 md:bottom-4 left-4 z-[550] w-11 h-11 flex items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:brightness-110 hover:scale-105 active:scale-95 transition-all duration-200 pointer-events-auto"
        ...
        {/* Banner marquee no rodape do mapa */}
        <div className="absolute bottom-0 left-0 right-0 z-[550] overflow-hidden pointer-events-none pb-20 md:pb-5">
          <div className="animate-marquee whitespace-nowrap text-xs md:text-sm font-semibold text-slate-500 tracking-wide px-4">
            {'Ajude outros pais e respons\u00e1veis, cadastrando valores de mensalidades e avaliando escolas. Esse projeto depende de voc\u00ea. Compartilhe com outros respons\u00e1veis. \u00a0\u00a0\u2022\u00a0\u00a0'}
          </div>
        </div>
      </div>
