    ...
    <div className="min-h-dvh bg-bg text-text selection:bg-primary/30">
      ...
      <div className="fixed inset-0 bottom-0 z-[500] pointer-events-none">
        ...
        <a
          ...
          className="absolute bottom-20 md:bottom-20 left-4 z-[550] w-11 h-11 flex items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:brightness-110 hover:scale-105 active:scale-95 transition-all duration-200 pointer-events-auto"
        ...
        <div className="absolute bottom-0 left-0 right-0 z-[550] overflow-hidden pointer-events-none" style={{ marginBottom: '48px' }}>
          <div className="animate-marquee whitespace-nowrap text-xs md:text-sm font-semibold text-text/90 tracking-wide px-4">
